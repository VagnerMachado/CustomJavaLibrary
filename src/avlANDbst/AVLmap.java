 ...
 * figure out which rotations are necessary, and added the AVLrebalance to deleteMin() and remove() and put() methods.
 *  
...
public class AVLmap<K extends Comparable<K>, V> implements Map<K,V>
{
	...
	/**
	 * AVLmap constructor - map has a null root
	 */
	public AVLmap()
	{
		root = null;
	...
	@Override
	/**
	 * isEmpty - accessor for the status of the tree
